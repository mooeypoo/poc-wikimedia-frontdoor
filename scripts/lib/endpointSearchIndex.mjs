...
/*
 * Both packages are pinned to an exact version in package.json, and both need
 * to be: workspace-store is 0.x, so it makes us no semver promise, and
 * `helpers` is an exports-map subpath rather than a documented API surface.
 */
