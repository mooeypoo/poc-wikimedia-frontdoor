...
| Personal API keys | Section heading + description + learn-more (owner-only consumers) above cards; list-element card (title, quiet Reset, destructive quiet Delete — **idle** / no-op, Issued \| Status \| Permissions). **Row data = placeholders** |
