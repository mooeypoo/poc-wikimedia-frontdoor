...
| **[`.agents/skills/codex-bidirectionality/SKILL.md`](.agents/skills/codex-bidirectionality/SKILL.md)** | Codex BiDi/RTL style guide + Front Door isolation and CSS direction practices (subordinate to this file) |
| **[`.agents/skills/codex-layout/SKILL.md`](.agents/skills/codex-layout/SKILL.md)** | Codex overflow, links/buttons, and forms layout guidelines (subordinate to this file and `DESIGN_REQUIREMENTS.md`) |
| **Other [`.agents/skills/`](.agents/skills/)** | Codex components, tokens, icons, usage, and design principles (ProtoWiki-derived; Front Door rules in `AGENTS.md` take precedence) |
