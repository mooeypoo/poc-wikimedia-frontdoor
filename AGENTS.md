...
- API catalog Wikimedia cards, project-filter options, visibility (`universal` / `projects` / `excludeProjectIds`), and filter combobox inline size (`config/apiCatalogWikimedia.ts` — `API_CATALOG_PROJECT_FILTER_COMBOBOX_INLINE_SIZE`)
