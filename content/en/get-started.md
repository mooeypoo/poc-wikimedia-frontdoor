...
:::navigation-card-grid
::navigation-card{url="/get-started/featured-apps" title="Featured apps" description="See examples of open source apps and data visualizations built with Wikimedia content and data."}
::

::navigation-card{url="/get-started/tutorials" title="Tutorials" description="Follow coding exercises with step-by-step guidance."}
::

::navigation-card{url="/get-started/by-language" title="Browse by programming language" description="Find client libraries, example apps, and open source projects in your preferred coding languages."}
::
:::
