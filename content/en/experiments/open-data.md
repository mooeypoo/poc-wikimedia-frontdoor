...
- Identify your client with a descriptive User-Agent header.
- Check the license of each dataset before you redistribute it.
- Prefer bulk downloads over crawling when you need data at scale.

| Data source | Format | Best for |
| --- | --- | --- |
| Dumps | XML \| SQL | Bulk analysis of a project's full history |
| Streams | JSON | Reacting to changes as they happen |

## Explore APIs

:::navigation-card-grid
::navigation-card{url="/explorer" title="Lift Wing API" description="Get predictions from Wikimedia machine learning models"}
::
:::
...
:::navigation-card-grid
::navigation-card{url="https://doc.wikimedia.org/generated-data-platform/aqs/analytics-api/tutorials/compare-page-metrics.html" title="Compare page metrics" description="Analyze page viewership and edit data from Wikipedia." supporting-text="Read the tutorial"}
::
