...
| Collapsed search button activation | **Implemented** — `useShellCollapsedSearchOverlay`; `ShellHeaderSearchOverlay`; backdrop-light; `cdxIconClose` close button; autofocused field; `shell-collapsed-search-overlay.css` scroll lock |
