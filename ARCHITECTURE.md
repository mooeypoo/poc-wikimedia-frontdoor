...
| Active address-bar server host is not production (e.g. `test.wikimedia.org` while exploring `enwiki`) | Warning **hidden**; **reappears** when production is selected again |
