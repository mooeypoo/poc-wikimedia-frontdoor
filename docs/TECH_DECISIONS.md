...
| Navigation cards | ✅ Implemented | `NavigationCard.vue` + `NavigationCardGrid.vue` — Figma variant A; content-authored labels in `<bdi>`; see `ARCHITECTURE.md` → Navigation card |
