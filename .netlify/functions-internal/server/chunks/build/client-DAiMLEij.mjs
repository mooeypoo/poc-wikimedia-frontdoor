...
import { y as pascalCase, v as kebabCase, G as withoutTrailingSlash, h as destr, m as getRequestHeaders } from '../nitro/nitro.mjs';
import { find, html } from 'property-information';
import { toHast } from 'minimark/hast';
import { t as tryUseNuxtApp, h as useRuntimeConfig } from './server.mjs';
...
const localComponentLoaders = {
  Alert: () => import('./Alert-BiPlNT6O.mjs').then((m) => pickExport(m, "default", "Alert", "./../../../../../app/components/Alert.vue")),
  Counter: () => import('./Counter-DvpFz4xp.mjs').then((m) => pickExport(m, "default", "Counter", "./../../../../../app/components/Counter.vue"))
};
...
//# sourceMappingURL=client-DAiMLEij.mjs.map
