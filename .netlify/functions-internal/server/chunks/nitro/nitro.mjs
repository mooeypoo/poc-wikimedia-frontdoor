...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "a324419c-572c-47f1-a4e7-5ccf8f61b0f6",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/home/moriel/code/wikimedia/frontdoor/.data/content/contents-3816520.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _Ffvbnz = eventHandler(async (event) => {
...
const _4G2m9I = eventHandler(async (event) => {
...
const _lazy_jeNXVu = () => import('../routes/api/discovery.get.mjs');
const _lazy_EeAkm1 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/discovery', handler: _lazy_jeNXVu, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_EeAkm1, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _Ffvbnz, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _Ffvbnz, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _4G2m9I, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _4G2m9I, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_EeAkm1, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, sanitizeStatusCode as A, useNitroApp as B, useRuntimeConfig as C, withLeadingSlash as D, withQuery as E, withTrailingSlash as F, withoutTrailingSlash as G, buildAssetsURL as a, baseURL as b, createError$1 as c, decodePath as d, defineEventHandler as e, defineRenderHandler as f, defu as g, destr as h, encodePath as i, executeAsync as j, getContext as k, getQuery as l, getRequestHeaders as m, getResponseStatus as n, getResponseStatusText as o, getRouteRules as p, handler as q, hasProtocol as r, hash$1 as s, isScriptProtocol as t, joinURL as u, kebabCase as v, parseQuery as w, parseURL as x, pascalCase as y, publicAssetsURL as z };
